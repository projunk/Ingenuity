...
void setup() {
  ...
  server.on("/Save", WebRequestMethod::HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    topServoCenterOffset = checkCenterOffset(request->getParam(getIdFromName(NAME_TOP_SERVO_CENTER_OFFSET))->value().toInt());
    bottomServoCenterOffset = checkCenterOffset(request->getParam(getIdFromName(NAME_BOTTOM_SERVO_CENTER_OFFSET))->value().toInt());
  ...
  server.on("/Defaults", WebRequestMethod::HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    topServoCenterOffset = defaultTopServoCenterOffset;
    bottomServoCenterOffset = defaultBottomServoCenterOffset;
